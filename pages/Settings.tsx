  ...
  FOR EACH ROW EXECUTE PROCEDURE public.handle_new_user();`;
    ...
    const TabButton = ({ id, label, icon: Icon }: any) => (
        <button
            ...
            className={`flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-all w-full md:w-auto text-left ${activeTab === id
                ...
                <div className="flex-1 min-w-0">
                    ...
                    {activeTab === 'profile' && (
                        <div className="space-y-6 animate-fade-in">
                            <div className="bg-brand-dark border border-zinc-800 rounded-xl p-6 md:p-8">
                                <div className="flex flex-col items-center sm:flex-row sm:items-start gap-6 mb-8 border-b border-zinc-800/50 pb-8">
                                    <div className="relative group">
                                        ...
                                        <button
                                            ...
                                            disabled={saving}
                                            className="absolute bottom-0 right-0 p-2 bg-brand-gold text-black rounded-full shadow-lg hover:bg-white transition-colors disabled:opacity-50 ring-4 ring-brand-dark"
                                        >
                    ...
                    {/* TAB: SECURITY */}
                    {activeTab === 'security' && (
                        <div className="bg-brand-dark border border-zinc-800 rounded-xl p-6 md:p-8 animate-fade-in">
                        ...
                        <div className="space-y-6 animate-fade-in">
                            <div className="bg-brand-dark border border-zinc-800 rounded-xl p-6 md:p-8">
                                ...
                                <div className="relative group">
                                    ...
                                    <pre id="sql-schema" className="bg-brand-darker p-6 rounded-lg border border-zinc-800 text-[10px] md:text-[11px] font-mono text-zinc-400 overflow-x-auto leading-relaxed max-h-[400px] custom-scrollbar selection:bg-brand-gold/30 selection:text-white shadow-inner">
                                        {sqlSchema}
                                    </pre>
                                </div>
                            </div>
